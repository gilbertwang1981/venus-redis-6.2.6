...
#define VENUS_REDIS_MSGQ_SLOWLOG_FETCH_USLEEP 20000
#define VENUS_REDIS_MYSQL_KEEPALVE_INTERVAL 15000000
...
#define VENUS_SLOWLOG_KEEPALIVE_DB_COMMAND_NAME "venus-slowlog-keepalive-db-command"
